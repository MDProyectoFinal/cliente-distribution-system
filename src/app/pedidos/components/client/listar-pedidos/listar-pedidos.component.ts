...
export class ListarPedidosComponent implements OnInit {
  ...
  constructor(private _usuarioServicio: UsuarioService, private _pedidoServicio: PedidoService, private _fb: FormBuilder, public _authServices: AuthenticationService, private pagoSerivce: PagoService, private alertifyService: AlertifyService) {
